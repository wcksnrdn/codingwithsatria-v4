        ...
        <div>
          ...
          <MagneticEffect>
            <NavMenuLink
              ...
              active={active}
              duration={1.2}
              handleScroll={() => handleScroll("#certificate")}
            />
          </MagneticEffect>
          <MagneticEffect>
            <NavMenuLink
          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1}
                link="https://github.com/wcksnrdn"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/satriaardan/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.4}
                link="https://instagram.com/satriardann"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.6}
                link="https://tiktok.com/@satriardan"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.8}
                link="mailto:ardansatria004@gmail.com"
              />
            </MagneticEffect>
          </div>
